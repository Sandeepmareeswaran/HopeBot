...
interface ChatSidebarProps {
  ...
  onLogout: () => void;
  className?: string;
  translations: Translations['chatSidebar'];
}
      ...
      <div className="mt-auto">
        <div className="flex items-center gap-3 mb-2 p-2 rounded-lg">
          <Avatar className="h-9 w-9">
            <AvatarImage src={`https://api.dicebear.com/8.x/bottts/svg?seed=${userEmail}`} alt={translations.userAvatar} />
